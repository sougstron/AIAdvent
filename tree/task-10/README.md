...
/ + буквы      многоуровневый автокомплит: ↑↓ выбор, → подставить,
               Enter подставить (а терминальную команду — сразу выполнить),
...
фактов); `→` подставляет кандидата в ввод (с одним пробелом, если у уровня
