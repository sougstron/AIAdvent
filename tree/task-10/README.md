...
/ + буквы      многоуровневый автокомплит: ↑↓ выбор, Tab/→ подставить,
...
возвращается при стирании. `Enter` ведёт себя как `→`, но терминальную
команду (`/new`, `/branch show`, `/branch switch main`) сразу выполняет.
